...
<body class="bg-white">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <button class="btn btn-primary my-4" onclick="window.location = '../form/index.html'">Tambah Pengguna Baru</button>
            </div>
            ...
            <button class="btn btn-primary" type="submit" id="button-addon2" style="background-color:rgb(35, 29, 210); color: white;">Cari</button>
